...
int menuPrincipal(){
    ...
    do{        
        ...
        printf("1 - Executar ordenacao por Bubble Sort\n");
        printf("2 - Executar ordenacao por Insertion Sort\n");
        printf("3 - Executar ordenacao por Selection Sort\n");
		printf("4 - Executar ordenacao por Shell Sort\n");
        printf("5 - Cancelar\n\n");
